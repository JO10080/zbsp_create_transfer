		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zbspbzzbspcreatetransfer-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbspbzzbspcreatetransfer-display": {
								"semanticObject": "zbspbzzbspcreatetransfer",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbsp.bz.zbspcreatetransfer",
									"url": sap.ui.require.toUrl("zbsp/bz/zbspcreatetransfer")
								}
							}
						}
					}
