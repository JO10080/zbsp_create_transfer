sap.ui.define([
  ...
  // This method returns an array that contains all entries of the array aArray that are truthy (in the same order).
    ...
    handleSave : function () {
      ...
      oEntry.Partner              = this.getView().byId("partnerIdInput_ach").getValue();

      oEntry.OrderName            = this.getView().byId("partnerNameInput_ach").getText(); // SE NECESITA
      oEntry.RecipientAccountId   = this.getView().byId("recipientAccountIdInput_ach").getValue(); // SE NECESITA
      oEntry.AccountId            = this.getView().byId("accountIdInput_ach").getValue();
      oEntry.Amount               = this.getView().byId("amountInput_ach").getValue();
      oEntry.Currency             = this.getView().byId("currencyBox_ach").getSelectedKey();

      oEntry.Description          = this.getView().byId("addendaInformationInput_ach").getValue();//agregado
      oEntry.BankCode             = this.getView().byId("destinationBankInput_ach").getValue();//agregado
      oEntry.RecipientName        = this.getView().byId("recipientNameInput_ach").getValue();
      oEntry.RecipientAddress     = this.getView().byId("recipientAddressInput_ach").getValue();

      //oEntry.Description        = this.getView().byId("descriptionInput").getValue(); se elimino el campo descripcion
      //oEntry.CustomerValueDate  = this.getView().byId("customerValueDateInput").getDateValue();

      //oEntry.RecipientId        = this.getView().byId("recipientIdInput").getValue(); se elimino el id del beneficiario
      //oEntry.RecipientIdType    = this.getView().byId("recipientIdTypeBox").getSelectedKey(); se elimino

      if(oEntry.TransactionTypeCode!=="03"){
        oEntry.RecipientBankKey     = this.getView().byId("recipientBankBox_ach").getSelectedKey();
      }else{
        oEntry.RecipientBankKey     = this.getView().byId("recipientBankInput_ach").getValue();
      }

      oEntry.RecipientAccountId   = this.getView().byId("recipientAccountIdInput_ach").getValue();
      //oEntry.RecipientAccountType = this.getView().byId("recipientAccTypeBox").getSelectedKey(); se elimino el campo


      //Revisar odata PaymentOrderSet
    ...
    handleMessageDialogOpen: function ( sPaymentOrderId) {
      ...
      this._oMessageDialog.toggle(this.getView().byId("btnSave"));
    },
    ...
    _handlePartnerSelectionChange : function (evt) {
      ...
      if (oSelectedItem) {
        ...
        this.getView().byId("partnerNameInput_ach").setText(oSelectedItem.getDescription());
        this._partnerHelpDialog.close();
      }
      sap.ui.getCore().byId("partnerList").removeSelections(true);
    },
    _handleAccountValueHelp : function(oEvent) {
      var sInputValue = this.getView().byId("partnerIdInput_ach").getValue(); //oEvent.getSource().getValue();
    ...
    _handleAccountValueHelpSearch : function (evt) {
      ...
      var sPartnerValue = this.getView().byId("partnerIdInput").getValue();
    ...
    _getNonMandatoryInputFields: function() {
      return fnArrayFilteredTruthy([
           //this.byId("descriptionInput"), se elimino este campo
           this.byId("recipientAddressInput"),
  ...
  //if(oTrans === "01"){
        return fnArrayFilteredTruthy([
          this.byId("partnerIdInput_ach"),
          this.byId("accountIdInput_ach"),
          this.byId("amountInput_ach"),
          this.byId("currencyInput_ach"),
          this.byId("recipientNameInput_ach"),
          this.byId("addendaInformationInput_ach"),
          this.byId("destinationBankInput_ach"),
          //this.byId("recipientIdInput"), se elimino el campo 
          this.byId("recipientAccountIdInput_ach"),
          this.byId("confirmAccountInput_ach"),
          this.byId("recipientBankInput_ach")
          ]);
    //}
    },
    _getMandatorySelectFields: function() {
      ...
      return fnArrayFilteredTruthy([
        ...
        //this.byId("recipientIdTypeBox"), se elimino el campo
        this.byId("recipientBankBox"),
        //this.byId("recipientAccTypeBox"), se e;imino el campo
        ]);
    ...
    _clearInputFields: function() {
      ...
      this.getView().byId("btnSave_ach").setEnabled(true);
      this.getView().byId("partnerNameInput_ach").setText("");
    ...
    _disableInputFields: function() {
      ...
      this.getView().byId("btnSave_ach").setEnabled(false);
    }
